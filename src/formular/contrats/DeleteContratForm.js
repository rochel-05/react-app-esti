...
class DeleteContratForm extends Component{
    render(){
        return(
            ...
            <div className="col-lg-1 mt-4 offset-1">
                <img src={contratImg} alt="module image" className="rounded-circle border border-primary"/>
            </div>
            <div className="col-lg-7 offset-2 mt-4 pl-5">
                <h1 style={{color:"orange", textAlign:"center"}}>Suppression d'un Contrat</h1>
                <form className="form form-vertical">
                <div className="form-group row">
                        <label for="idContrat" className="col-md-2 col-form-label">Id</label>
                        <div className="col-md-10">
                            <input type="email" className="form-control" id="idContrat"/>
                        </div>
                    </div>
                    <div className="form-group row">
...
export default DeleteContratForm;